                ...
                <div class="first grid">
                    <h2>
                        ...
                        if (isset($_GET['display'])) {
                            ...
                            switch($display){
                                case 'ACTIVE': echo "All Active Customers (Customers who have orders)"; break;
                                case 'CCREDITS': echo 'Customers with Outstanding Credits'; break;
                                case 'CREFCREDITS': echo 'Customers with Referral Credits'; break;
                                case 'CCART': echo 'Customers with items in cart'; break;
                                case 'Create Order': 
                                    echo "Which Customer?";
                                    $display = "";
                                    break;
                            ...
                            $display = "";
                            ?>
                        <form method='post'>All Customers 
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#example').dataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "inc.ajax_customers.php?display=<?php echo $display; ?>",
                    "columnDefs": [{
                        "targets": 0,
