                ...
                <div class="floatright">
                    <div class="floatleft">
                       <?php
						...
						$qry = "SELECT * FROM `company_cross` WHERE `u_id`='" . $_SESSION['userid'] . "'";
						$result = mysql_query($qry)or die(mysql_error());
						$companies = "";
						while ($row = mysql_fetch_assoc($result)){
        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">
                    ...
                    <a href="inventory.php?additem=1">Add Inventory Item</a> 
					...
					if (isset($_GET['additem'])){
						...
						//display the form
						?>
						<form action="add_inven_item.php" method="POST">
						<table>
						<tr><td>Company:</td><td>
						<select name="company" />
						<?php
						connectToSQL();
						$qry = "SELECT * FROM `companies` WHERE `id`>='1'";
						$result = mysql_query($qry)or die(mysql_error());
						...
						<tr><td>Item Amount:</td><td><input type="number" name="amount" /></td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td>Alarm when quantity at:</td><td><input type="number" name="alarm" /></td></tr>
					...
					?>
                    <br /><br />View inventory:<br /><br />
					
					<?php
					//lets view all items we have in inventory.
					connectToSQL();
					$qry = "SELECT * FROM `inventory_items` WHERE `id`>='0'";
					$result = mysql_query($qry)or die(mysql_error());
					echo "<table>";
					?>
					...
					while ($row = mysql_fetch_assoc($result)){
						...
						$qry2 = "SELECT * FROM `inventory_items` WHERE `id`='" . $id . "'";
						$result2 = mysql_query($qry2)or die(mysql_error());
						...
						if ($amount <= $alarm){
							$qry3 = "UPDATE `users` SET `alarm`='1' WHERE `id`='" . $_SESSION['userid'] . "'";
							mysql_query($qry3)or die(mysql_error());
							
							$_SESSION['alarm'] = 1 ;
						}
						
						echo "<tr><td>" . $id . "</td><td>" . $name . "</td><td>" . $amount . "</td><td>" . $company . "</td></tr>";
					}
					mysql_close();
					echo "</tbody>";
					echo "</table>";
